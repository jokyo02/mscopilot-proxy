...
async function handleRequest(request, env,ctx) {
    ...
    return proxyLinkHttp(request, [
     ...
     //   }
        ...
        if (p == "/" || p.startsWith("/rp/") || p == "/favicon.ico" || p.startsWith("/fd/") ||  p.startsWith("/chats/") || p.startsWith("/locales/") || p.startsWith("/c/api/") ||  p.startsWith("/cl/") || p.startsWith("/rewardsapp/") || p.startsWith("/notifications/") || p.startsWith("/sa/") || p.startsWith("/rs/") || p.startsWith("/sharing/") || p.startsWith("/sydchat/") || p.startsWith("/turing/") || p.startsWith("/th") || p.startsWith("/Identity/") || p.startsWith("/hamburger/") || p.startsWith("/secure/") || p == "/bingufsync" || p == "/passport.aspx" || p.startsWith("/images/") || p.startsWith("/idp/") || p.startsWith("/cdx/") || p.startsWith("/pwa/") || p.startsWith("/videos/")) {
